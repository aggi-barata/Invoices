...
\author{%\centerline {39-24-18/1, Madhavadhara, I E Post, Visakhapatnam - 7}\\ 
 \scriptsize Invoice No: PG22022013 \hspace*{3.25cm}  Invoice YR: 2013 \hspace*{3.25cm} Date: 22-Feb-2013\\
$\rule{7in}{0.5mm}$}
\date{}
\begin{document}
\maketitle
...
\begin{tabular}{l}
 \ \\
SPX Flow Technology\\
Survey No. 275, Odhav Road, Odhav,\\
...
%\hline
 ...
 \hline\ & & &  & &  \\
  ...
  1.  &   \parbox{2.8in}{\footnotesize    Charges for 250 TPH Sea Water Pump set shock test arrangements \& environment vibration test simulation.

}

 &   Nos & 1.00 & 187,000.00 & 187,000.00 \\
