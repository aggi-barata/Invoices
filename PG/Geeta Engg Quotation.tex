...
\author{%\centerline {39-24-18/1, Madhavadhara, I E Post, Visakhapatnam - 7}\\ 
 \scriptsize Quotation No: PG25052013 \hspace*{3.25cm}  Quotation YR: 2013 \hspace*{3.25cm} Date: 10-June-2013\\
$\rule{7in}{0.5mm}$}
\date{}
\begin{document}
\maketitle
...
%\hline
 ...
 \hline\ & & &  & &  \\
  ...
  1.  &   \parbox{3.25in}{\footnotesize   Shock, vibration and bump test analysis of the following items. 
   \begin{enumerate}
   \item Electromagnetic Brake.
   \item Drum Controller Indication Panel.
   \item Emergency Foot Switch.
   \item Drum Controller.
   
   \end{enumerate}}

 &   Nos & 4.00 & 25,000.00 & 100,000.00 \\
