...
\author{%\centerline {39-24-18/1, Madhavadhara, I E Post, Visakhapatnam - 7}\\ 
 \scriptsize Invoice No: GKL18022013  \hspace*{3.25cm}  Invoice YR: 2013 \hspace*{3.25cm} Date: 18-Feb-2013\\
$\rule{7in}{0.5mm}$}
\date{}
\begin{document}
\maketitle
...
\begin{flushright}
\begin{tabular}{l}
\footnotesize \bf KAO: Deep Vasudeva\\
\footnotesize Head (Special Projects)\\
\end{tabular}
\end{flushright}
...
\end{tabular}} \\
 ...
 \hline\ & & &  & &  \\
  ...
  1.  &   \parbox{3.5in}{\footnotesize  Charges towards design and fabrication of test fixtures for vibration and bump.}
