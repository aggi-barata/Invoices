...
\author{%\centerline {39-24-18/1, Madhavadhara, I E Post, Visakhapatnam - 7}\\ 
 \scriptsize Invoice No: RK25112011/1  \hspace*{4cm}  Invoice YR: 2011 \hspace*{4cm} Date: 25-Nov-2011\\
$\rule{7.3in}{0.5mm}$}
\date{}
\begin{document}
\maketitle
...
%\hline
 ...
 \hline\ & & &  & &  \\
  ...
  1.  &   \parbox{3.5in}{\footnotesize SHOCK, VIBRATION, BUMP AND SHIP MOTION ANALYSIS OF 40 kVA ROTARY CONVERTER.
