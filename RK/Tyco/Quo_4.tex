...
\author{%\centerline {39-24-18/1, Madhavadhara, I E Post, Visakhapatnam - 7}\\ 
 \scriptsize Quotation No: RK16122010/3  \hspace*{4cm}  Quotation YR: 2010 \hspace*{4cm} Date: 16-Dec-2010\\
$\rule{7.0in}{0.5mm}$}
\date{}
\begin{document}
\maketitle
...
%\hline
 ...
 \hline\ & & &  & &  \\
  ...
  1.  &  \parbox{3.2in} {\scriptsize CHARGES FOR SHOCK TESTS, ABN and NOISE TEST (SBN) FOR
...
\hline
\ & & & \\
Wafer BFV Manual & 250 & F360 & LM6 \\
Wafer BFV Manual & 300 &F360 & LM6 \\
\ & & & \\
