...
\author{%\centerline {39-24-18/1, Madhavadhara, I E Post, Visakhapatnam - 7}\\ 
 \scriptsize Invoice No: RK24092012 \hspace*{3.25cm}  Invoice YR: 2012 \hspace*{3.25cm} Date: 01-Oct-2012\\
$\rule{7in}{0.5mm}$}
\date{}
\begin{document}
\maketitle
...
%\hline
 \hline
 \multicolumn{6}{|c|}{  \begin{tabular}{c} \ \\ \LARGE \bf {Invoice} \\ \ \\ REFERENCE NO: PO. 2012110087  \hspace*{1.6cm}  PO. YR:  2012  \hspace*{1.6cm} DATE: 26-Sep-2012 \\ \ \\ \end{tabular}} \\
 ...
 \hline\ & & &  & &  \\
  ...
  1.  &   \parbox{3.5in}{\footnotesize  TESTING CHARGES \\ FOR AFU PANELS AT VIZAG.
