...
\author{%\centerline {39-24-18/1, Madhavadhara, I E Post, Visakhapatnam - 7}\\ 
 \scriptsize Invoice No: RK28092011  \hspace*{3.25cm}  Invoice YR: 2011 \hspace*{3.25cm} Date: 27-September-2011\\
$\rule{7in}{0.5mm}$}
\date{}
\begin{document}
\maketitle
...
%\hline
 \hline
 \multicolumn{6}{|c|}{  \begin{tabular}{c} \ \\ \LARGE \bf { Invoice} \\ \ \\ \parbox{6.2in}{Supplier Code: R00499 { \hspace*{7cm} Order Date: 12-September-2011} } \\ \ \\ \end{tabular}} \\
 ...
 \hline\ & & &  & &  \\
  ...
  1.  &   \parbox{3.5in}{\footnotesize Shock Analysis of LV 3305 41006889.
