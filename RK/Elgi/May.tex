...
\author{%\centerline {39-24-18/1, Madhavadhara, I E Post, Visakhapatnam - 7}\\ 
 \scriptsize Invoice No: RK04052012 \hspace*{3.25cm}  Invoice YR: 2012 \hspace*{3.25cm} Date: 04-May-2012\\
$\rule{7in}{0.5mm}$}
\date{}
\begin{document}
\maketitle
...
%\hline
 \hline
 \multicolumn{6}{|c|}{  \begin{tabular}{c} \ \\ \LARGE \bf { Invoice} \\ \ \\ \parbox{6.2in}{Supplier Code: R00499 { \hspace*{7cm} Order Date: } } \\ \ \\ \end{tabular}} \\
 ...
 \hline\ & & &  & &  \\
  ...
  1.  &   \parbox{3.5in}{\footnotesize  FE  MODELLING AND SHOCK ANALYSIS OF WP 5000 COMPRESSOR.
...
\hline
& \\
Service Tax @ 12.36\% & 24,720.00 \\
& \\
\hline
& \\
{\bf Grand Total (INR)} & 224,720.00 \\
& \\
\hline
\end{tabular}
