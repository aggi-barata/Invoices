...
\author{%\centerline {39-24-18/1, Madhavadhara, I E Post, Visakhapatnam - 7}\\ 
 \scriptsize Quotation No: RK4052012 \hspace*{3.25cm}  Quotation YR: 2012 \hspace*{3.25cm} Date: 5-May-2012\\
$\rule{7in}{0.5mm}$}
\date{}
\begin{document}
\maketitle
...
%\hline
 \hline
 \multicolumn{6}{|c|}{  \begin{tabular}{c} \ \\ \LARGE \bf { Quotation} \\ \ \\ %\parbox{6.2in}{Supplier Code: R00499 { \hspace*{7cm} Order Date: } } \\ \ \\ 
	 \end{tabular}} \\
