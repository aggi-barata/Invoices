...
\author{%\centerline {39-24-18/1, Madhavadhara, I E Post, Visakhapatnam - 7}\\ 
 \scriptsize Invoice No: RK09052012 \hspace*{3.25cm}  Invoice YR: 2012 \hspace*{3.25cm} Date: 9-May-2012\\
$\rule{7in}{0.5mm}$}
\date{}
\begin{document}
\maketitle
...
%\hline
 \hline
 \multicolumn{6}{|c|}{  \begin{tabular}{c} \ \\ \LARGE \bf { Invoice} \\ \ \\ \parbox{6.2in}{Work Order: KITL / WO / 0013 { \hspace*{7cm} Order Date: 24-Feb-2012 } } \\ \ \\ 
	 \end{tabular}} \\
...
\hline
& \\
\ Less Advance (30\%) & 231,630.00\\
& \\
\hline
& \\
{\bf Grand Total (INR)} & 540,470.00 \\
& \\
\hline
\end{tabular}
